...
<CodeSurfer
  title="ecr-sample.cr"
  code={require('!raw-loader!./examples/ecr-sample.cr').trim()}
  lang="ruby"
/>
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/ecr-sample.ecr').trim()}
  lang="html"
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/ecr-sample.log').trim()}
  lang="text"
  steps={[
    {},
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/ecr-sample.ecr.cr').trim()}
  lang="ruby"
  steps={[
    {},
...
<CodeSurfer
  title="new.cr"
  code={require('!raw-loader!./examples/new-1.cr').trim()}
  lang="ruby"
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/new-1.log').trim()}
  lang="text"
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/new-2.cr').trim()}
  lang="ruby"
...
<CodeSurfer
  ...
  code={require('!raw-loader!./examples/new-2.log').trim()}
  lang="text"
