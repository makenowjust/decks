...
## About Me
  ...
  - Frontend Engineer at Space Pirates Inc.
...
<CodeSurfer
  title="ecr-sample.cr"
  code={require("!raw-loader!./examples/ecr-sample.cr")}
  lang="ruby"
/>
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/ecr-sample.ecr")}
  lang="html"
  steps={[
    {},
    {lines: [6], notes: '"tilte" is misspelled...'},
  ]}
/>
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/ecr-sample.log")}
  lang="text"
  steps={[
    {},
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/ecr-sample.ecr.cr")}
  lang="ruby"
  steps={[
    {},
    {lines: [1, 3, 5], notes: 'These lines are corresponding to literal texts simply.'},
    {lines: [2, 4], notes: 'These line are corresponding to <%= ... %>, however, what is #<loc:...>?'},
  ]}
/>
...
<CodeSurfer
  title="new.cr"
  code={require("!raw-loader!./examples/new-1.cr")}
  lang="ruby"
  steps={[
    {},
    {lines: [5], notes: 'BadType is not defined of course.'},
  ]}
/>
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/new-1.log")}
  lang="text"
  steps={[
    {},
    {lines: [11, 12, 13], notes: 'Show macro generated code. But is it useful?'},
  ]}
/>
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/new-2.cr")}
  lang="ruby"
  steps={[
    {},
    {lines: [2], notes: 'Build loc pragma by hand.'},
  ]}
/>
...
<CodeSurfer
  ...
  code={require("!raw-loader!./examples/new-2.log")}
  lang="text"
  steps={[
    {notes: 'Then, it shows really clear error message.'},
  ]}
/>
